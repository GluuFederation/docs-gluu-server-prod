...
Gluu Server offers REST APIs for the [oxTrust Admin GUI](https://gluu.org/docs/gluu-server/4.2/admin-guide/oxtrust-ui/). With the REST API, server configurations can be automated, new GUIs can be built to expose specific admin functionality, and other integrations can be created for the Gluu admin portal.

## VM Installation instructions

Add the REST API extension to an existing Gluu 4.2.x deployment by following these steps:

1. Inside the Gluu chroot, navigate to `/custom/libs/`.

1. In this folder, download the .jar file corresponding to the Gluu Server 4.2 version currently installed:

    - [4.2.1.Final](https://ox.gluu.org/maven/org/gluu/oxtrust-api-server/4.2.1.Final/oxtrust-api-server-4.2.1.Final.jar)
    - [4.2.2.Final](https://ox.gluu.org/maven/org/gluu/oxtrust-api-server/4.2.2.Final/oxtrust-api-server-4.2.2.Final.jar)
    - [4.2.2.sp1](https://ox.gluu.org/maven/org/gluu/oxtrust-api-server/4.2.2.sp2/oxtrust-api-server-4.2.2.sp1.jar)
    - [4.2.3.Final](https://ox.gluu.org/maven/org/gluu/oxtrust-api-server/4.2.3.Final/oxtrust-api-server-4.2.3.Final.jar)
    - [4.2.3.sp1](https://ox.gluu.org/maven/org/gluu/oxtrust-api-server/4.2.3.sp2/oxtrust-api-server-4.2.3.sp1.jar)
    - [4.2.3.sp2](https://ox.gluu.org/maven/org/gluu/oxtrust-api-server/4.2.3.sp2/oxtrust-api-server-4.2.3.sp2.jar)
...
1. [Restart](https://gluu.org/docs/gluu-server/4.2/operation/services/#restart) the `identity` service.
...
1.  Set environment variable `GLUU_OXTRUST_API_ENABLED=true` and `GLUU_OXTRUST_API_TEST_MODE=true` when running `gluufederation/persistence` container to enable oxTrust API:
    ...
    docker run \
        ...
        gluufederation/persistence:4.2.3_01
    ```
...
1. [Restart](https://gluu.org/docs/gluu-server/4.2/operation/services/) the `identity` service
