...
=== "Helm"
    ...
    === "config"   
        ...
        | `config.image.tag`                                    | Config image tag                                                                                                                 | `4.2.3_03`                                                  |
    ...
    === "jackrabbit"
        ...
        | `jackrabbit.image.tag`                             | Jackrabbit image tag repository                                                                                                  | `4.2.3_02`                          |
    ...
    === "opendj"
        ...
        | `opendj.image.tag`                                 | Opendj image tag repository                                                                                                      | `4.2.3_02`                          |
    ...
    === "persistence"
        ...
        | `persistence.image.tag`                            | Persistence image tag repository                                                                                                 | `4.2.3_03`                          |
    ...
    === "oxauth"
        ...
        | `oxauth.image.tag`                                 | oxAuth image tag repository                                                                                                      | `4.2.3_06`                          |
    ...
    === "oxtrust"
        ...
        | `oxtrust.image.tag`                                | oxTrust image tag repository                                                                                                     | `4.2.3_02`                          |
    ...
    === "fido2"
        ...
        | `fido2.image.tag`                                  | Fido2 image tag repository                                                                                                       | `4.2.3_02`                          |
    ...
    === "scim"
        ...
        | `scim.image.tag`                                   | SCIM image tag repository                                                                                                        | `4.2.3_02`                          |
    ...
    === "oxd-server"
        ...
        | `oxd-server.image.tag`                             | oxd Oauth client image tag repository                                                                                            | `4.2.3_02`                          |
    ...
    === "casa"
        ...
        | `casa.image.tag`                                   | Casa image tag repository                                                                                                        | `4.2.3_02`                          |
    ...
    === "oxpassport"
        ...
        | `oxpassport.image.tag`                             | oxPassport image tag repository                                                                                                  | `4.2.3_04`                          |
    ...
    === "oxshibboleth"
        ...
        | `oxshibboleth.image.tag`                           | oxShibboleth image tag repository                                                                                                | `4.2.3_04`                          |
    ...
    === "radius"
        ...
        | `radius.image.tag`                                 | Radius image tag repository                                                                                                      | `4.2.3_02`                          |
    ...
    === "cr-rotate"
        ...
        | `cr-rotate.image.tag`                              | Cache Refresh image tag repository                                                                                               | `4.2.3_03`                          |
    ...
    === "oxauth-key-rotation"
        ...
        | `oxauth-key-rotation.image.tag`                         | oxAuth Key Rotation image tag repository                                                                                    | `4.2.3_07`                          |
...
| `UPGRADE_IMAGE_TAG`                             | Gluu upgrade image tag                                                           | i.e `"4.2.3_02"`                                                                            |
