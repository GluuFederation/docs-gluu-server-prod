...
=== "Helm"
    ...
    === "config"   
        ...
        | `config.image.tag`                                    | Config image tag                                                                                                                 | `4.3.0_02`                                                  |
    ...
    === "jackrabbit"
        ...
        | `jackrabbit.image.tag`                             | Jackrabbit image tag repository                                                                                                  | `4.3.0_02`                          |
    ...
    === "opendj"
        ...
        | `opendj.image.tag`                                 | Opendj image tag repository                                                                                                      | `4.3.0_02`                          |
    ...
    === "persistence"
        ...
        | `persistence.image.tag`                            | Persistence image tag repository                                                                                                 | `4.3.0_02`                          |
    ...
    === "oxauth"
        ...
        | `oxauth.image.tag`                                 | oxAuth image tag repository                                                                                                      | `4.3.0_03`                          |
    ...
    === "oxtrust"
        ...
        | `oxtrust.image.tag`                                | oxTrust image tag repository                                                                                                     | `4.3.0_02`                          |
    ...
    === "fido2"
        ...
        | `fido2.image.tag`                                  | Fido2 image tag repository                                                                                                       | `4.3.0_02`                          |
    ...
    === "scim"
        ...
        | `scim.image.tag`                                   | SCIM image tag repository                                                                                                        | `4.3.0_02`                          |
    ...
    === "oxd-server"
        ...
        | `oxd-server.image.tag`                             | oxd Oauth client image tag repository                                                                                            | `4.3.0_02`                          |
    ...
    === "casa"
        ...
        | `casa.image.tag`                                   | Casa image tag repository                                                                                                        | `4.3.0_02`                          |
    ...
    === "oxpassport"
        ...
        | `oxpassport.image.tag`                             | oxPassport image tag repository                                                                                                  | `4.3.0_02`                          |
    ...
    === "oxshibboleth"
        ...
        | `oxshibboleth.image.tag`                           | oxShibboleth image tag repository                                                                                                | `4.3.0_02`                          |
    ...
    === "radius"
        ...
        | `radius.image.tag`                                 | Radius image tag repository                                                                                                      | `4.3.0_02`                          |
    ...
    === "cr-rotate"
        ...
        | `cr-rotate.image.tag`                              | Cache Refresh image tag repository                                                                                               | `4.3.0_02`                          |
    ...
    === "oxauth-key-rotation"
        ...
        | `oxauth-key-rotation.image.tag`                         | oxAuth Key Rotation image tag repository                                                                                    | `4.3.0_02`                          |
...
| `RADIUS_IMAGE_TAG`                              | Radius image tag                                                                 | i.e `"4.3.0_02"`                                                                            |
