...
=== "Minikube"
    ...
    1. **Optional[alpha]:** If using Istio please [install](https://istio.io/latest/docs/setup/install/) it prior to installing Gluu. You may choose to use any installation method Istio supports.Please note that at the moment Istio ingress is not supported with Minikube. 
...
=== "Helm"
    ...
    1. **Optional:** If using couchbase as the persistence backend. Download the [couchbase](https://www.couchbase.com/downloads) kubernetes operator package for linux and place it in the same directory as `pygluu-kubernetes.pyz`
    ...
    1.  **Optional:** If using couchbase as the persistence backend.
        ...
        1. Download the [couchbase](https://www.couchbase.com/downloads) kubernetes operator package for linux and place it in the same directory as `pygluu-kubernetes.pyz`
    ...
    === "config"   
        ...
        | config.image.tag | string | `"4.4.0_b1"` | Image  tag to use for deploying. |
    ...
    === "jackrabbit"
        ...
        | jackrabbit.image.tag | string | `"4.4.0_b1"` | Image  tag to use for deploying. |
    ...
    === "opendj"
        ...
        | opendj.image.tag | string | `"4.4.0_b1"` | Image  tag to use for deploying. |
        ...
        | opendj.readinessProbe | object | `{"exec":{"command":["python3","/app/scripts/healthcheck.py"]},"failureThreshold":20,"initialDelaySeconds":25,"periodSeconds":25,"timeoutSeconds":5}` | Configure the readiness healthcheck for OpenDJ if needed. https://github.com/GluuFederation/docker-opendj/blob/4.4/scripts/healthcheck.py |
    ...
    === "persistence"
        ...
        | Key | Type | Default | Description |
        |-----|------|---------|-------------|
        | persistence | object | `{"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","repository":"gluufederation/persistence","tag":"4.4.0_b1"},"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Job to generate data and initial config for Gluu Server persistence layer. |
        ...
        | persistence.image.tag | string | `"4.4.0_b1"` | Image  tag to use for deploying. |
    ...
    === "oxauth"
        ...
        | oxauth.image.tag | string | `"4.4.0_b1"` | Image  tag to use for deploying. |
    ...
    === "oxtrust"
        ...
        | oxtrust.image.tag | string | `"4.4.0_b1"` | Image  tag to use for deploying. |
    ...
    === "fido2"
        ...
        | fido2.image.tag | string | `"4.4.0_b1"` | Image  tag to use for deploying. |
    ...
    === "scim"
        ...
        | scim.image.tag | string | `"4.4.0_b1"` | Image  tag to use for deploying. |
    ...
    === "oxd-server"
        ...
        | oxd-server.image.tag | string | `"4.4.0_b1"` | Image  tag to use for deploying. |
        | oxd-server.livenessProbe | object | `{"exec":{"command":["curl","-k","https://localhost:84.4/health-check"]},"initialDelaySeconds":30,"periodSeconds":30,"timeoutSeconds":5}` | Configure the liveness healthcheck for the auth server if needed. |
        | oxd-server.livenessProbe.exec | object | `{"command":["curl","-k","https://localhost:84.4/health-check"]}` | Executes the python3 healthcheck. |
        | oxd-server.readinessProbe | object | `{"exec":{"command":["curl","-k","https://localhost:84.4/health-check"]},"initialDelaySeconds":25,"periodSeconds":25,"timeoutSeconds":5}` | Configure the readiness healthcheck for the auth server if needed. |
    ...
    === "casa"
        ...
        | casa.image.tag | string | `"4.4.0_b1"` | Image  tag to use for deploying. |
    ...
    === "oxpassport"
        ...
        | oxpassport.image.tag | string | `"4.4.0_b1"` | Image  tag to use for deploying. |
    ...
    === "oxshibboleth"
        ...
        | oxshibboleth.image.tag | string | `"4.4.0_b1"` | Image  tag to use for deploying. |
    ...
    === "cr-rotate"
        ...
        | cr-rotate.image.tag | string | `"4.4.0_b1"` | Image  tag to use for deploying. |
    ...
    === "oxauth-key-rotation"
        ...
        | Key | Type | Default | Description |
        |-----|------|---------|-------------|
        | oxauth-key-rotation | object | `{"dnsConfig":{},"dnsPolicy":"","image":{"pullPolicy":"IfNotPresent","repository":"gluufederation/certmanager","tag":"4.4.0_b1"},"keysLife":48,"resources":{"limits":{"cpu":"300m","memory":"300Mi"},"requests":{"cpu":"300m","memory":"300Mi"}},"usrEnvs":{"normal":{},"secret":{}},"volumeMounts":[],"volumes":[]}` | Responsible for regenerating auth-keys per x hours |
        ...
        | oxauth-key-rotation.image.tag | string | `"4.4.0_b1"` | Image  tag to use for deploying. |
...
| ----------------------------------------------- |---------------------------------------------------------------------------------------------| ------------------------------------------------------------------------------------------- |
| `ACCEPT_GLUU_LICENSE`                           | Accept the [License](https://gluu.org/docs/gluu-server/4.4/#license/)                       | `"Y"` or `"N"`                                                                              |
