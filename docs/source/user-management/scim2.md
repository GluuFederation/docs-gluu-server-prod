...
If you prefer reading code, [patch test cases](https://github.com/GluuFederation/SCIM-Client/blob/version_3.1.8/scim-client2/src/test/java/gluu/scim2/client/patch) found in the Java SCIM-Client project are worth to look at.
...
```
<properties>
	<scim.client.version>3.1.8.Final</scim.client.version>
</properties>
...
<repositories>
  <repository>
...
Ideally, the SCIM-Client you use should match your Gluu version. For example, if you are running Gluu Server CE v3.1.8, you should also use SCIM-Client v3.1.8.
...
* [FullUserTest](https://github.com/GluuFederation/SCIM-Client/blob/version_3.1.8/scim-client2/src/test/java/gluu/scim2/client/singleresource/FullUserTest.java)
...
* [PatchUserExtTest](https://github.com/GluuFederation/SCIM-Client/blob/version_3.1.8/scim-client2/src/test/java/gluu/scim2/client/patch/PatchUserExtTest.java)
