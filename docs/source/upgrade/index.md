...
=== "Community Edition"
    ...
    * Execute the script:
    ...
    Your upgrade directory will be the `/opt/upd/4.3.1/dist`. The script will create these sub directories: `app`, `gluu`, and `tmp`. It also download latest setup files to `/install/community_edition_setup_4.3.1`.
